          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              <div class="text-center">
                <img class="profile-user-img img-fluid img-circle" src="<?= base_url('admin_photo/' . session()->get('photo')); ?>" alt="User profile picture">
              </div>
              ...
              <div class="tab-content">
                ...
                <form class="form-horizontal" action="<?= base_url('admin/update/' . $users['id']) ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="inputEmail" value="<?= session()->get('email') ?>">
                    </div>
                  </div>
                  <div class="form-group row">
