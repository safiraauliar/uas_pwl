                ...
                <div class='list-frame artikel' id="artikel-Sejarah Desa Sekartaji">
                    ...
                    <div class='artikel-gambar mb10'>
                        <a href="" class='fancybox' rel="99">
                            <img class='full' src="<?= base_url(); ?>/lte/dist/img/visimisi.png" />
                        </a>
                    </div>
                    <div class='artikel-konten clearfix'>
                        ...
                        <p style="text-align: justify;">VISI
                            <p style="text-align: justify;">
                                Terwujudnya Pemerintah Desa yang baik untuk mendukung tercapainya masyarakat yang sejahtera, mandiri dalam lingkungan kehidupan masyarakat yang terbuka, demokratis dan semarak.</p>
                            <p style="text-align: justify;">
                                MISI
                            </p>
                            <p style="text-align: justify;">
                            ...
                            <p style="text-align: justify;">3. Membangun semoga otonomi desa yang sejati dan bermakna bagi masyarakat.</p>
                        </p>
