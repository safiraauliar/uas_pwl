                ...
                <div class='list-frame artikel' id="artikel-Sejarah Desa Sekartaji">
                    ...
                    <div class='artikel-gambar mb10'>
                        <a href="" class='fancybox' rel="99">
                            <img class='full' src="<?= base_url(); ?>/lte/dist/img/konoha.jpg" />
                        </a>
                    </div>
                    <div class='artikel-konten clearfix'>
                        <p style="text-align: center;">Berikut ini <?= $title; ?></p>
                        <p style="text-align: justify;">Selamat Datang di Website Resmi Desa Sekartaji , Kecamatan Nusapenida Kabupaten Klungkung. Media komunikasi dan transparansi Pemerintah Desa Sekartaji untuk seluruh masyarakat.</p>
                    </div>
