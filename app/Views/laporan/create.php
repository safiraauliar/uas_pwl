    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-xl-8 offset-xl-2 py-5">
                ...
                <form id="contact-form" method="post" action="<?= base_url('laporan/save') ?>" role="form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="tgl_lapor" type="text" name="tgl_lapor" class="form-control" placeholder="15 Juli 2000" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="isi_laporan" name="isi_laporan" class="form-control" placeholder="Silahkan isi Laporan anda disini *" rows="4" required="required" data-error="Silahkan isi pesan atau keterangan anda."></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <input type="submit" class="btn btn-success btn-send" value="Kirim Permohonan">
                                <a href="<?= base_url('laporan/display_laporan') ?>" id="cancel" name="cancel" class="btn btn-primary">Tampilkan Laporan</a>
